...
const RelatedDoctors = ({ speciality, docId }) => {
    ...
    return (
        <div className='flex flex-col items-center gap-4 my-16 text-[#262626]'>
            ...
            {/* Display message when no related doctors are found */}
            {relDoc.length === 0 ? (
                <p className="text-gray-500 mt-4">No doctors available in this specialty at the moment.</p>
            ) : (
            ...
            {/* Uncomment if you want to add a "Load More" button */}
            {/* <button className='bg-[#EAEFFF] text-gray-600 px-12 py-3 rounded-full mt-10'>More</button> */}
        </div>
    )
}
